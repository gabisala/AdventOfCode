...
def simulate_in_console(puzzle_state,stacks):
    """
...
with open('AdventOfCode/2022/Day_5/input.txt', 'r') as file:
...
simulate_in_console('original', crates_stacks)
...
simulate_in_console('first', crates_stacks_first_puzzle)         
...
simulate_in_console('second', crates_stacks_second_puzzle)
